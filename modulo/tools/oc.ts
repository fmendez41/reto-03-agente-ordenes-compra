import { z } from "zod"
import { crearAccion, consumirAccion, validarAccion } from "../core/confirmacion.ts"
import { flushIntento, intentoVacio, type Intento } from "../core/control.ts"
import { escribirEvidenciaTxt } from "../core/evidencia.ts"
import { construirOrden, guardarTrazabilidad, hashPayload, ordenCompraSchema } from "../core/payload.ts"
...
import { crearSapArchivo, excluirReferencia, leerOrdenes } from "../core/sap-archivo.ts"
import type { OrdenCompra, Ubicacion } from "../core/types.ts"
...
async function escribirPdfSiSePuede(
  ...
  try {
    const { escribirEvidenciaPdf } = await import("../core/pdf.ts")
